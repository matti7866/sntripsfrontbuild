<?php
/**
 * Company Information API - DEBUG VERSION
 */
...
$companyNumber = isset($_GET['companyNumber']) ? trim($_GET['companyNumber']) : '1206022';
...
curl_setopt($ch, CURLOPT_COOKIEJAR, dirname(__FILE__) . "/cookies_ci_debug.txt");
...
curl_setopt($ch, CURLOPT_COOKIEFILE, dirname(__FILE__) . '/cookies_ci_debug.txt');
$a = curl_exec($ch);
...
echo "<h2>Debug Information - Company Information</h2>";
echo "<h3>Company Number: $companyNumber</h3>";
